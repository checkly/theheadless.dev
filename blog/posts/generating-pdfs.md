...
The generate PDF feature allows us to easily transform existing web pages into PDF format, just as we have done in our example. An even more interesting use case is revealed when we need to produce a document in PDF format: now we can use our existing HTML and CSS skills to produce high-quality material, often eliminating the need for LaTeX or similar tools.

See points 2 and 3 of the following section for examples of this approach.
